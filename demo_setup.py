...
Remember: Your responses will be converted to speech, so write how you'd naturally speak.""",
    ...
    log("  1. Open the unified interface at: " + BASE_URL)
    log("  2. Login to Agent Manager tab with your admin credentials")
    log("  3. Edit Sage's system prompt and observe audit logging")
    log("  4. Toggle Echo's TTS settings on/off")
    log("  5. Start a conversation with each agent in Session Control")
    log("  6. Monitor live messages in the Live Monitor tab")
