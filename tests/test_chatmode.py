...
from chatmode.providers import (
    OllamaChatProvider,
...
class TestMemoryStore:
    ...
    def test_memory_initialization(
        self, mock_embedding_provider, tmp_path, unique_collection_name
    ):
    ...
    def test_memory_add_with_metadata(
        self, mock_embedding_provider, tmp_path, unique_collection_name
    ):
    ...
    def test_memory_ignores_empty_text(
        self, mock_embedding_provider, tmp_path, unique_collection_name
    ):
...
class TestOllamaEmbeddingProvider:
    ...
    @patch("chatmode.providers.requests.post")
...
class TestSessionManagement:
    ...
    @pytest.mark.asyncio
    async def test_session_generates_unique_id(self, mock_settings):
        ...
        with patch.object(session, "_task"):
    ...
    @pytest.mark.asyncio
    async def test_session_stores_topic(self, mock_settings):
        ...
        with patch.object(session, "_task"):
            with patch("chatmode.session.load_agents", return_value=[Mock(), Mock()]):
                await session.start("Is AI conscious?")
...
class TestWebAPI:
    ...
    def test_health_endpoint(self, client):
        ...
        assert data["framework"] == "chatmode"
